...
import (
	...
	"github.com/xiazeyin/fabric-sdk-go-gm/pkg/common/errors/retry"
	"github.com/xiazeyin/fabric-sdk-go-gm/pkg/common/errors/status"
	"github.com/xiazeyin/fabric-sdk-go-gm/pkg/common/providers/fab"
	"github.com/xiazeyin/fabric-sdk-go-gm/pkg/common/providers/msp"
	"github.com/xiazeyin/fabric-sdk-go-gm/pkg/core/config"
	lcpackager "github.com/xiazeyin/fabric-sdk-go-gm/pkg/fab/ccpackager/lifecycle"
	"github.com/xiazeyin/fabric-sdk-go-gm/pkg/fabsdk"
	"github.com/xiazeyin/fabric-sdk-go-gm/third_party/github.com/xiazeyin/fabric-gm/common/policydsl"
	"strings"
)
...
func approveCC(packageID string, ccName, ccVersion string, sequence int64, channelID string, orgs []*OrgInfo, ordererEndpoint string) error {
	...
	for _, org := range orgs {
		...
		fmt.Println(">>> orgPeers.url:", orgPeers[0].URL())
